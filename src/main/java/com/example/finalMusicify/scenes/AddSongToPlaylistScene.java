...
public class AddSongToPlaylistScene {
    ...
    public static Pane createView(String playlistId, Runnable onBack) {
        ...
        Button submit = new Button("✅ Add to Playlist");
        ...
        submit.setOnAction(e -> {
            ...
            data.put("playlistId", playlistId); // ✅ Important
            ...
            resultLabel.setText(success ? "✅ Song added to playlist." : "❌ Failed to add.");
        });

        HBox buttons = new HBox(10, submit, backBtn);
        buttons.setAlignment(Pos.CENTER);

        backBtn.setOnAction(e -> onBack.run());

        wrapper.getChildren().addAll(title, form, buttons, resultLabel);
        return wrapper;
    }
}
